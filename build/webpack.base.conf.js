...
module.exports = {
  ...
  entry: {
    ...
    posts: ['babel-polyfill',`${PATHS.src}/posts`],
    about: ['babel-polyfill',`${PATHS.src}/about`],
    post: ['babel-polyfill',`${PATHS.src}/post`]
  ...
  plugins: [
    ...
    */
    ...
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/posts/index.html`,
      filename: './posts/index.html',
      inject: true,
      chunks: ['posts', 'vendors'],
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/post/index.html`,
